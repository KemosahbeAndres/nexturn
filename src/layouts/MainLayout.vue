<template>
  <div class="flex h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <nav class="md:hidden shrink-0 h-16 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex items-center justify-around px-2 transition-colors duration-300">
