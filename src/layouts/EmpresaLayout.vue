  ...
  <div class="flex h-[100dvh] bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <main
        ...
        :class="isPanelCompleto
          ? 'flex flex-col overflow-hidden'
          : 'overflow-y-auto p-4 sm:p-6 lg:p-8 pb-20 md:pb-8'"
      >
        <router-view />
      </main>
    </div>
...
const PANEL_COMPLETO_ROUTES = ['empresa-sucursales', 'empresa-ajustes-usuarios', 'empresa-ajustes-cargos'];

const isActive = (routeName: string) => route.name === routeName;
const isMenuItemActive = (routeName: string) => isActive(routeName);
const isPanelCompleto = computed(() => PANEL_COMPLETO_ROUTES.includes(route.name as string));
