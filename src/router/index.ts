  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'presencias', name: 'sucursal-presencias', meta: { title: 'Presencias', subtitle: 'Disponibilidad diaria del equipo', requiresActiveSubscription: true }, component: () => import('../views/sucursal/PresenciasView.vue') },
